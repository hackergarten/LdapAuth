...
public class LdapAuthenticator {
    ...
    private final static String contextFactory = "com.sun.jndi.ldap.LdapCtxFactory"
      ...
      DirContext ldapContext () throws Exception {
        Hashtable<String,String> env = new Hashtable <String,String>();
        return ldapContext(env);
    }

      DirContext ldapContext (Hashtable <String,String>env) throws Exception {
     ...
     String getUid (String user) throws Exception {
     ...
     boolean testBind (String dn, String password) throws Exception {
        Hashtable<String,String> env = new Hashtable <String,String>();
    ...
    def search(String uid){
        def ldap = ldapContext()
